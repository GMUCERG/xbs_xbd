...
{
  k = buf+CANARY_SZ;
  s = k+crypto_aead_KEYBYTES+CANARY_SZ*2;
  p = s+crypto_aead_NSECBYTES+CANARY_SZ*2;
  a = p+crypto_aead_NPUBBYTES+CANARY_SZ*2;
  m = a+MAXTEST_BYTES+CANARY_SZ*2;
  c = m+MAXTEST_BYTES+CANARY_SZ*2;
  t = c+(MAXTEST_BYTES+crypto_aead_ABYTES)+CANARY_SZ*2;
  r = t+(MAXTEST_BYTES+crypto_aead_ABYTES)+CANARY_SZ*2;
  k2 = r+crypto_aead_NSECBYTES+CANARY_SZ*2;
  s2 = k+crypto_aead_KEYBYTES+CANARY_SZ*2;
  p2 = s+crypto_aead_NSECBYTES+CANARY_SZ*2;
  a2 = p+crypto_aead_NPUBBYTES+CANARY_SZ*2;
  m2 = a+MAXTEST_BYTES+CANARY_SZ*2;
  c2 = m+MAXTEST_BYTES+CANARY_SZ*2;
  t2 = c+(MAXTEST_BYTES+crypto_aead_ABYTES)+CANARY_SZ*2;
  r2 = t+(MAXTEST_BYTES+crypto_aead_ABYTES)+CANARY_SZ*2;
  //Randomize contents
