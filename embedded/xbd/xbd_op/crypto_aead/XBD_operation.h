...
#define MAX_PARAM_SIZE (LENGSIZE*5+NUMBSIZE+(MAX_KEYBYTES+MAX_NSECBYTES+MAX_MSG_BYTES+MAX_TEST_AD_BYTES+MAX_NPUBBYTES))

#define MAX_ENCRYPT_OUTPUT_SIZE (NUMBSIZE+MAX_MSG_BYTES+MAX_ABYTES)
#define MAX_DECRYPT_OUTPUT_SIZE (NUMBSIZE+LENGSIZE*2+MAX_MSG_BYTES+MAX_NSECBYTES)
...
#define XBD_PARAMLENG_MAX (MAX_TESTBUFFER_SIZE > MAX_PARAM_SIZE ? MAX_TESTBUFFER_SIZE:MAX_PARAM_SIZE)
#define XBD_RESULTLEN (MAX_ENCRYPT_OUTPUT_SIZE > MAX_DECRYPT_OUTPUT_SIZE ? MAX_ENCRYPT_OUTPUT_SIZE : MAX_DECRYPT_OUTPUT_SIZE)
