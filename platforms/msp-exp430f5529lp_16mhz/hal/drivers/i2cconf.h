...
///** @todo check maximum size sent from xbh */
//#define I2C_RECEIVE_DATA_BUFFER_SIZE	160
#define I2C_BUFFER_SIZE	160

//Use same buffer for both send and receive
#define I2C_RECEIVE_DATA_BUFFER_SIZE I2C_BUFFER_SIZE
#define I2C_SEND_DATA_BUFFER_SIZE I2C_BUFFER_SIZE
